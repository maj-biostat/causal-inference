...
The author, Judea Pearl, reviews the problems associated with this perspective.
...
Pearl introduces the structural causal model framework where:
...
These, like diet and exercise in the obesity example presented by Hernan, have side effects.
Nevertheless, we do not think it necessary to discuss $V$, $N$ or $T$ when we are talking about how tyre pressure effects the likelihood of punctures on unsealed roads, or a bumpy ride in general.
...
This paper is no exception and therefore some of important points may have been missed in this summary.

The subtleties of some of the language are difficult. 
For example, what Pearl means by *causal character* is unclear.

Some of the critique on consistency as an assumption versus consistency as a theorem was unclear due to insufficient familiarity with alternative frameworks for conceptualising causal inference.
...
However, I am not sure that it provides a clear way forward and the applied researcher is left to choose which approach to adopt.
